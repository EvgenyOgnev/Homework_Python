...
print(f'1. Расстояние между А({x1}, {y1}) и В({x2}, {y2}) = {round (ab**0.5, 2)}')  # 1-й вариант решения
import math
print(f'2. Расстояние между А({x1}, {y1}) и В({x2}, {y2}) = {round (math.sqrt(ab), 2)}') # 2-й вариант решения
